...
<TR>
<TD>
<form action  = "http://css1.seattleu.edu/~kwong1/dbtest/seriesPackaged.php" method = "get">
    <input type = "submit"  value = "Go back to Series Packaged Table" />	
</form> 
</TD>	
<TD>
...
$numOfSeriesPackaged = $_POST['numOfSeriesPackaged'];

$query = "SELECT DISTINCT S.stitle, P.pname FROM Series S, PackagedBy PB, 
Publisher P WHERE S.sid = PB.sid and PB.pid = P.pid LIMIT $numOfSeriesPackaged";

$query_html = htmlspecialchars($query);

$result = mysql_query($query);
if (!$result) {
    print "Error - The number exceeded the number of Series Packaged stored in this database.";
    $error = mysql_error();
    print "<p>" . $error . "</p>";
    exit;
}
